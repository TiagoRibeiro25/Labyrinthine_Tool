...
const WarningIcon: React.FC<SVGProps<SVGSVGElement>> = (props): React.JSX.Element => {
	return (
		<svg
		...
		>
			...
			></path>
			<path fill="currentColor" d="M256 397.25a20 20 0 1 1 20-20a20 20 0 0 1-20 20"></path>
		</svg>
	);
};
